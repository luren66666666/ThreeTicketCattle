<template>
    <div class="list">
            <van-tabs v-model="active"  swipeable sticky offset-top="30px">
                <van-tab title="推荐" >
                     <li class="list-conten" @click="showDeraily">
                ...
                <van-tab title="合辑" class= "van-tab--active">
                 <ul class="collection">
                   <li v-for="(item,index) in 3" :key="index">
                     <div class="collection-img">
                       <img src="/img/组 5.0f58a53c.png" alt="">
                     </div>
                     <div class="collection-content">
                       <p class="content-title">
                         <span class="title-weight" >2020音乐节</span>
                         <span>2020</span>
                       </p>
                ...
                <van-tab title="榜单" class= "van-tab--active">内容 4</van-tab>
            </van-tabs>
        </div>
